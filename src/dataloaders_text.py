...
class caption_dataset:
    def __init__(self):
        ...
        self.coco_captions_2014_path = self.data_dir + "Image_Caption_Dataset/annotations_trainval2014/annotations/captions_train2014.json"
        self.coco_captions_2017_path = self.data_dir + "Image_Caption_Dataset/annotations_trainval2017/annotations/captions_val2017.json"

        self.coco_image_dir_2014 = self.data_dir + "Image_Caption_Dataset/train2014/train2014"
        self.coco_image_dir_2017 = self.data_dir + "Image_Caption_Dataset/val2017/val2017"
    ...
    def get_dataloader(self, partition, batch_size, distributed = False):
